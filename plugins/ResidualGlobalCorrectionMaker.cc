...
//       if (it==track.recHitsBegin()) {
//         hits.push_back(TrackingRecHit::RecHitPointer(new InvalidTrackingRecHit(*detectorG, TrackingRecHit::missing)));
//       }
...
//                   
//                   
//                   dxpxb1 = preciseHit->localPosition().x() - updtsos.localPosition().x();
